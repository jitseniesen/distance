...
def compute_distance(point1, point2):
    ...
    coordinates. The function returns the distance, which
...
def compute_minimum_distance(points):
    ...
    Given a list of point, compute the distance between
    all pairs of points and return the minimum of these
    distances.
    """
    distances = []
